...
# Método Insertar
    public function set_perusuario($bean_perusuario)
    {
        ...
        $this->query = "CALL usp_set_perusuario('$perapellidos','$pernombre','$perusuario','$perpassword','$fechareg','$estado')";
        $this->execute_query();
        $data = $this->rows ;
        return $data;
...
# Método Actualizar
    public function upd_perusuario($bean_perusuario)
    {
        ...
        $this->query = "CALL usp_upd_perusuario('$idperusuario','$perapellidos','$pernombre','$perusuario','$perpassword')";
        $this->execute_query();
        $data = $this->rows ;
        return $data;
...
# Método get Seleccionar todos
    public function get_perusuario_by_usuario_password($bean_perusuario)
    {
        $perusuario   = $bean_perusuario->getPerUsuario();
        $perpassword  = $bean_perusuario->getPerPassword();
        $this->query = "CALL usp_get_perusuario_by_usuario_password('$perusuario','$perpassword')";
        $this->execute_query();
        $data = $this->rows ;
        return $data;
    }
