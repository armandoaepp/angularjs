...
# Método Buscar por ID
	...
	# Método Buscar por ID
	public function get_cellocator_by_ExtInputF($beanCellocator)
	{
		$ExtInputF      = !empty($beanCellocator->getExtInputF()) ? $beanCellocator->getExtInputF() : 1 ;

		$this->query = "CALL usp_get_cellocator_by_ExtInputF('$ExtInputF')";
		$this->execute_query();
		$data = $this->rows ;
		return $data;
	}
...
/*
$ClsCellocator = new ClsCellocator() ;
$data = $ClsCellocator->get_cellocator_by_ExtInputF1() ;
